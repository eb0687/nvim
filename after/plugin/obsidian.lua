...
keymap_normal('<leader>ot', ':ObsidianTemplate<CR>', 'Open note in Obsidian (optional args)')
keymap_normal('<leader>oq', ':ObsidianQuickSwitch', 'Quickly switch between notes')
keymap_normal('<leader>ob', ':ObsidianBacklinks<CR>', 'Open Obsidian backlinks')
keymap_normal('<leader>ot', ':ObsidianToday<CR>', 'Create new daily note')
keymap_visual('<leader>ol', ':ObsidianLink ', 'Link an inline visual selection to an existing note (optional args)')
keymap_visual('<leader>Ol', ':ObsidianLinkNew ', 'Create a new note and link to a visual selection (optional args)')
