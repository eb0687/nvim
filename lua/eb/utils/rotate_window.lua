-- https://github.com/dmmulroy/kickstart.nix/blob/main/config/nvim/lua/user/rotate_windows.lua
vim.api.nvim_create_user_command("RotateWindows", function()
    local ignored_filetypes = { "neo-tree", "fidget", "Outline", "toggleterm", "qf", "notify", "trouble" }
